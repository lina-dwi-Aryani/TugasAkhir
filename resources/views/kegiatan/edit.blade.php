            ...
            <form action="{{ route('kegiatan.update', $kegiatan->id) }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ old('tanggal', $kegiatan->tanggal) }}" >
                    </div>
                    <div class="form-group col-md-6">
                        <label for="waktu" class="font-weight-bold">Waktu</label>
                        <input type="time" class="form-control" id="waktu" name="waktu" value="{{ old('waktu', $kegiatan->waktu) }}" >
                    </div>
                </div>
                <div class="form-group">
                    <label for="peserta_terlibat" class="font-weight-bold">Peserta Terlibat</label>
                    <input type="text" class="form-control" id="peserta_terlibat" name="peserta_terlibat" value="{{ old('peserta_terlibat', $kegiatan->peserta_terlibat) }}" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="personil_terlibat" name="personil_terlibat" value="{{ old('personil_terlibat', $kegiatan->personil_terlibat) }}" >
                </div>
                <hr>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_kalurahan" name="wilayah[nama_kalurahan]" >
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="rt" class="font-weight-bold">RT</label>
