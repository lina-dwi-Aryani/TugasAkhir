...
class KPExport implements FromCollection, WithEvents
{
    protected $data;
    protected $request;
    ...
    public function collection()
    {
        ...
        // Add main title
        $data[] = ['REKAP DATA KEGIATAN KABUPATEN KULON PROGO'];
        $currentRow++;
        $data[] = [];
        $currentRow++;
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function (AfterSheet $event) {
            ...
            $sheet->setCellValue('A1', 'REKAP DATA KEGIATAN KABUPATEN KULON PROGO');
            ...
            // Set judul sheet
            $event->sheet->setTitle('KULON PROGO');
        },
    ];
}
}