...
class BantulExport implements FromCollection, WithEvents
{
    protected $data;
    protected $request;
    ...
    public function collection()
    {
        ...
        // Add main title
        $data[] = ['REKAP DATA KEGIATAN KABUPATEN BANTUL'];
        $currentRow++;
        $data[] = [];
        $currentRow++;
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function (AfterSheet $event) {
            ...
            $sheet->setCellValue('A1', 'REKAP DATA KEGIATAN KABUPATEN BANTUL');
